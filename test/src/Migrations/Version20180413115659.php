 ...
 */
class Version20180413115659 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY idDriver');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE driver (idDriver INT NOT NULL, Name VARCHAR(45) NOT NULL COLLATE utf8_general_ci, PRIMARY KEY(idDriver)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
